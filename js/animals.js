...
const Animals = (() => {
  ...
  const svgArt = {
    'dolphin': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      <ellipse cx="50" cy="52" rx="32" ry="16" fill="#5b9bd5" />
      <ellipse cx="50" cy="52" rx="28" ry="13" fill="#7ec8e3" />
      <g class="swim-tail"><path d="M78 48 Q92 40 85 55 Q82 52 78 52Z" fill="#5b9bd5"/></g>
      <path d="M22 52 Q10 42 16 36 Q20 42 22 48Z" fill="#5b9bd5"/>
      <g class="swim-fin"><path d="M50 38 Q55 28 48 26 Q44 30 50 38Z" fill="#5b9bd5"/></g>
    ...
    'crab': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-claw-l"><path d="M26 54 Q10 44 14 38 Q18 42 22 48" fill="#e63946" stroke="#c1121f" stroke-width="1"/><path d="M14 38 Q8 34 12 30" fill="#e63946"/></g>
      <g class="swim-claw-r"><path d="M74 54 Q90 44 86 38 Q82 42 78 48" fill="#e63946" stroke="#c1121f" stroke-width="1"/><path d="M86 38 Q92 34 88 30" fill="#e63946"/></g>
      <g class="swim-leg"><path d="M36 74 Q34 82 30 80" fill="none" stroke="#e63946" stroke-width="3" stroke-linecap="round"/></g>
      <g class="swim-leg alt"><path d="M44 76 Q43 84 40 82" fill="none" stroke="#e63946" stroke-width="3" stroke-linecap="round"/></g>
      <g class="swim-leg"><path d="M56 76 Q57 84 60 82" fill="none" stroke="#e63946" stroke-width="3" stroke-linecap="round"/></g>
      <g class="swim-leg alt"><path d="M64 74 Q66 82 70 80" fill="none" stroke="#e63946" stroke-width="3" stroke-linecap="round"/></g>
    </svg>`,

    'sea-turtle': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-flipper-l"><ellipse cx="32" cy="42" rx="10" ry="6" fill="#52b788" transform="rotate(-20 32 42)"/></g>
      <circle cx="28" cy="40" r="3" fill="#1a1a2e"/>
      <circle cx="29" cy="39" r="1" fill="white"/>
      <g class="swim-flipper-l alt"><path d="M24 68 Q14 78 18 82" fill="#52b788" stroke="none"/><path d="M30 70 Q22 80 26 82" fill="#52b788"/></g>
      <g class="swim-flipper-r alt"><path d="M76 68 Q86 78 82 82" fill="#52b788" stroke="none"/><path d="M70 70 Q78 80 74 82" fill="#52b788"/></g>
      <path d="M50 76 Q50 86 46 84 Q50 88 54 84 Q50 86 50 76Z" fill="#52b788"/>
    </svg>`,

    'great-white-shark': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      <ellipse cx="50" cy="52" rx="34" ry="18" fill="#6c757d"/>
      <ellipse cx="50" cy="56" rx="30" ry="12" fill="#dee2e6"/>
      <g class="swim-tail"><path d="M80 46 Q96 38 90 54 Q86 50 82 50Z" fill="#6c757d"/></g>
      <path d="M20 52 Q8 40 14 34 Q18 40 20 48Z" fill="#6c757d"/>
      <g class="swim-fin"><path d="M50 34 Q56 18 50 16 Q44 18 50 34Z" fill="#6c757d"/></g>
    ...
    'octopus': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-tentacle"><path d="M30 55 Q20 70 24 80 Q26 78 28 72 Q30 68 32 58" fill="#9b5de5"/></g>
      <g class="swim-tentacle alt"><path d="M36 58 Q30 75 34 85 Q36 82 37 76 Q38 70 38 60" fill="#9b5de5"/></g>
      <g class="swim-tentacle alt2"><path d="M44 60 Q42 78 46 86 Q48 82 47 76 Q46 70 45 62" fill="#9b5de5"/></g>
      <g class="swim-tentacle alt3"><path d="M56 60 Q58 78 54 86 Q52 82 53 76 Q54 70 55 62" fill="#9b5de5"/></g>
      <g class="swim-tentacle alt2"><path d="M64 58 Q70 75 66 85 Q64 82 63 76 Q62 70 62 60" fill="#9b5de5"/></g>
      <g class="swim-tentacle alt"><path d="M70 55 Q80 70 76 80 Q74 78 72 72 Q70 68 68 58" fill="#9b5de5"/></g>
      <circle cx="34" cy="76" r="2" fill="#b185db"/>
      <circle cx="46" cy="82" r="2" fill="#b185db"/>
      <circle cx="66" cy="76" r="2" fill="#b185db"/>
    </svg>`,

    'orca': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      <ellipse cx="50" cy="52" rx="34" ry="18" fill="#1a1a2e"/>
      <ellipse cx="50" cy="58" rx="28" ry="10" fill="white"/>
      <g class="swim-tail"><path d="M80 46 Q96 38 90 55 Q86 50 82 50Z" fill="#1a1a2e"/></g>
      <path d="M20 52 Q8 40 14 34 Q18 40 20 48Z" fill="#1a1a2e"/>
      <g class="swim-fin"><path d="M50 34 Q56 18 50 14 Q44 18 50 34Z" fill="#1a1a2e"/></g>
      <ellipse cx="32" cy="50" r="6" fill="white"/>
      <circle cx="26" cy="48" r="3.5" fill="#1a1a2e"/>
      <circle cx="27" cy="47" r="1" fill="#333"/>
    </svg>`,

    'manta-ray': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-tentacle"><path d="M44 56 Q42 68 38 72" fill="none" stroke="#4a4e69" stroke-width="3" stroke-linecap="round"/></g>
      <g class="swim-tentacle alt"><path d="M56 56 Q58 68 62 72" fill="none" stroke="#4a4e69" stroke-width="3" stroke-linecap="round"/></g>
    </svg>`,

    'anglerfish': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-tail"><path d="M74 50 Q84 48 80 56 Q78 52 74 52Z" fill="#2d2d2d"/></g>
    </svg>`,

    'jellyfish': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      <g class="swim-bell">
      ...
      <g class="swim-tentacle"><path d="M28 50 Q30 58 26 70 Q28 66 32 58 Q34 54 32 50" fill="rgba(155,93,229,.5)"/></g>
      <g class="swim-tentacle alt"><path d="M36 52 Q38 64 34 78 Q36 72 40 64 Q42 58 40 52" fill="rgba(155,93,229,.5)"/></g>
      <g class="swim-tentacle alt2"><path d="M44 54 Q46 68 42 84 Q44 78 48 68 Q50 60 48 54" fill="rgba(155,93,229,.5)"/></g>
      <g class="swim-tentacle alt3"><path d="M52 54 Q54 68 58 84 Q56 78 52 68 Q50 60 52 54" fill="rgba(155,93,229,.5)"/></g>
      <g class="swim-tentacle alt2"><path d="M60 52 Q62 64 66 78 Q64 72 60 64 Q58 58 60 52" fill="rgba(155,93,229,.5)"/></g>
      <g class="swim-tentacle alt"><path d="M68 50 Q70 58 74 70 Q72 66 68 58 Q66 54 68 50" fill="rgba(155,93,229,.5)"/></g>
      <circle cx="42" cy="32" r="3" fill="rgba(255,255,255,.4)"/>
      <circle cx="58" cy="32" r="3" fill="rgba(255,255,255,.4)"/>
    </svg>`,

    'swordfish': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-tail"><path d="M80 44 Q94 36 88 52 Q84 48 80 48Z" fill="#1565c0"/></g>
      <g class="swim-fin"><path d="M58 36 Q64 22 58 20 Q52 22 58 36Z" fill="#1565c0"/></g>
      <circle cx="36" cy="47" r="3.5" fill="#1a1a2e"/>
      <circle cx="37" cy="46" r="1.2" fill="#42a5f5"/>
    </svg>`,

    'blue-whale': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      <ellipse cx="48" cy="52" rx="38" ry="20" fill="#3f51b5"/>
      <ellipse cx="48" cy="58" rx="34" ry="12" fill="#7986cb"/>
      <g class="swim-tail"><path d="M84 46 Q98 34 96 52 Q92 48 86 48Z" fill="#3f51b5"/><path d="M94 36 Q100 30 96 28" fill="#3f51b5"/><path d="M94 52 Q100 58 96 60" fill="#3f51b5"/></g>
    ...
    'crocodile': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-tail"><path d="M82 52 Q90 48 88 56 Q86 52 82 54Z" fill="#2e7d32"/></g>
      <g class="swim-leg"><path d="M42 68 Q40 76 36 74" fill="none" stroke="#2e7d32" stroke-width="4" stroke-linecap="round"/></g>
      <g class="swim-leg alt"><path d="M58 68 Q60 76 64 74" fill="none" stroke="#2e7d32" stroke-width="4" stroke-linecap="round"/></g>
    </svg>`,

    'sea-otter': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-arm"><path d="M30 55 Q26 48 32 50" fill="#795548"/></g>
      <g class="swim-arm alt"><path d="M70 55 Q74 48 68 50" fill="#795548"/></g>
    </svg>`,

    'penguin': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-flipper-l"><path d="M28 50 Q22 60 28 68" fill="#1a1a2e" stroke="none"/></g>
      <g class="swim-flipper-r"><path d="M72 50 Q78 60 72 68" fill="#1a1a2e" stroke="none"/></g>
      <path d="M40 82 Q38 86 44 86 L48 86 Q50 82 46 80Z" fill="#f4a236"/>
      <path d="M54 80 Q50 82 52 86 L56 86 Q62 86 60 82Z" fill="#f4a236"/>
    </svg>`,

    'polar-bear': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-arm"><path d="M30 62 Q24 74 30 80" fill="#f5f5f5"/></g>
      <g class="swim-arm alt"><path d="M70 62 Q76 74 70 80" fill="#f5f5f5"/></g>
    </svg>`,

    'seal': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-flipper-l"><path d="M26 60 Q16 66 20 72" fill="#78909c"/></g>
      <g class="swim-flipper-r"><path d="M74 60 Q84 66 80 72" fill="#78909c"/></g>
      <g class="swim-tail"><path d="M46 76 Q50 82 54 76" fill="#78909c"/></g>
    </svg>`,

    'iguana': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-tail"><path d="M72 56 Q86 54 90 58 Q86 60 72 58Z" fill="#558b2f"/></g>
      <g class="swim-leg"><path d="M36 70 Q32 80 28 78" fill="none" stroke="#558b2f" stroke-width="3" stroke-linecap="round"/></g>
      <g class="swim-leg alt"><path d="M64 70 Q68 80 72 78" fill="none" stroke="#558b2f" stroke-width="3" stroke-linecap="round"/></g>
    </svg>`,

    'walrus': `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" overflow="visible">
      ...
      <g class="swim-flipper-l"><path d="M24 62 Q16 68 20 76" fill="#8d6e63"/></g>
      <g class="swim-flipper-r"><path d="M76 62 Q84 68 80 76" fill="#8d6e63"/></g>
    </svg>`,
  };
